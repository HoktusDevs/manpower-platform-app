...
interface CustomDecisionSelectorProps {
  ...
  onUpdateComplete?: () => void; // Callback para cerrar el modal
}
...
const CustomDecisionSelector: React.FC<CustomDecisionSelectorProps> = ({
  ...
  const handleUpdateState = async () => {
    ...
    try {
      ...
      await onDecisionChange(selectedDecision as 'APPROVED' | 'REJECTED' | 'PENDING');

      // Pequeño delay para mostrar el estado "Actualizando..."
