                    ...
                    <div className="flex space-x-2">
                      ...
                      {!isJobExpired(job.expiresAt) && (
                        <button
                          ...
                          disabled={loading}
                          className="text-sm bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-500 disabled:opacity-50"
                        >
                          Aplicar
                        </button>
                      )}
              ...
              <div className="space-y-4">
                ...
                {!isJobExpired(selectedJob.expiresAt) && (
                  <button
                    ...
                    disabled={loading}
                    className="w-full bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50"
                  >
