      ...
      <div className="bg-white rounded-lg shadow-xl p-6 max-w-md w-full mx-4">
        ...
        <div className="flex space-x-3">
          <button
            onClick={onRenew}
            disabled={isRenewing}
            className="flex-1 bg-blue-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isRenewing ? (
